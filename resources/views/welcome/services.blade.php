...
<section id="coming">
    <section class="banner">
        <img src="/img/slider_5.png" alt="" class="banner-cover" style="height: 650px; width: 1281.94444444444px; margin: 0px 0px 0px -1.97222222222229px; transform: translateY(132.6px);">
    ...
    <section class="insert expose" data-to-animate="">
        <div class="center">
            <figure>
